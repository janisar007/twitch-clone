...
export const UserItem = ({username, imageUrl, isLive} : UserItemProps) => {
    ...
    const href = `/${username}` //here we are going to direct when ever we click on the user.
    const isActive = pathname === href; //with iAction, we are going to show wether the user is seeing our stream or not.
